...
cleanup-images:
	docker rmi -f $(IMAGE_BASENAME)/build:$(DOCKER_TAG) $(IMAGE_BASENAME)/testnso:$(DOCKER_TAG) $(IMAGE_BASENAME)/package:$(DOCKER_TAG)

.PHONY: all build push push-release tag-release dev-shell test cleanup-images
